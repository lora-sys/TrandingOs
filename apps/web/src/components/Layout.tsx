...
import { Activity, BarChart3, BookOpen, Boxes, BrainCircuit, ClipboardList, Database, FileClock, FolderKanban, LineChart, MessageSquare, NotebookPen, Settings, Shield } from "lucide-react";
